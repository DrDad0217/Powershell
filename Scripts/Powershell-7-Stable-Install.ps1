...
$ProgramPaths = @('C:\Program Files (x86)\Powershell\7\pwsh.exe','"C:\Program Files\PowerShell\7\pwsh.exe"')

Test-path $ProgramPaths
...
if (Test-path $ProgramPaths) {

    #Throw "$InstallerName is already installed..."
    Write-Host "$InstallerName is already installed..."
