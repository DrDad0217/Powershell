New-UDPage -Url "/User-Information" -Name "User Account Information And Group Memberships" -Content {
#User Table Begin        
$User_Props = @(
...
$Columns = @(
    ...
    New-UDTableColumn -Property DistinguishedName -Title DistinguishedName -Hidden
)
